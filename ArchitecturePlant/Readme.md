# Schneider Multi-Meter Monitoring System (Architecture Plant)

This project implements an industrial IoT gateway using an **ESP32** and a **W5500 Ethernet module**. The system polls data from multiple Schneider energy meters via RS485 and transmits the readings to a central server using UDP.
...
*   **Meter Model:** Schneider Energy Meters (EM6436H)
...
*   **kWh Register Address:** `2699` (Holding Register)
